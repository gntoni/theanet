...
"""
This code implements some typical layers for deep networks using theano library.
...
class LogisticRegression(object):
    ...
    def __init__(self, input, n_in, n_out):
        ...
        self.y_pred_w_prob = (self.y_pred, T.max(self.p_y_given_x, axis=1))
        # end-snippet-1
...
class ConvPoolLayer(object):
    ...
    def __init__(self, rng, input, filter_shape, image_shape, poolsize=(2, 2),border_mode='valid',subsample=(1,1),dropout_prob=1, validating=True):
        ...
        assert border_mode == 'valid' or border_mode == 'full'
        self.input = input
